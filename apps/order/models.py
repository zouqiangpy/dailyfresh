...
class OrderInfo(BaseModel):
    ...
    pay_method = models.SmallIntegerField(choices=PAY_METHODS,default=3,verbose_name='支付方式')
...
class OrderGoods(BaseModel):
    ...
    sku = models.ForeignKey('goods.GoodsSKU',on_delete=models.CASCADE,verbose_name='商品数目')
